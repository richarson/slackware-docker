...
MIRROR="http://mirrors.us.kernel.org/slackware/"
...
chroot . sh -c 'yes y | linux32 /usr/sbin/slackpkg -batch=on -default_answer=y update'
chroot . sh -c 'linux32 /usr/sbin/slackpkg -batch=on -default_answer=y upgrade-all'
